...
namespace TS3AudioBot
{
	...
	public static class MainCommands
	{
		...
		public static void CommandAdd(PlayManager playManager, InvokerData invoker, string parameter) => playManager.Enqueue(invoker, parameter).UnwrapThrow();
		...
		public static string CommandCheck(ITargetManager targetManager)
		{
			return "Targeted Clients: " + targetManager.WhisperClients.Count;
		}
		...
		//new version cmds:
		[Command("move", "Move the bot to a channel.")]
		[Usage("<channelid>", "Where?")]
		public static string CommandMove(Bot bot, String parameter = null)
		{
			if(parameter == null)
				throw new CommandException("You need to specify channelid", CommandExceptionReason.CommandError);
			if(!ulong.TryParse(parameter, out ulong channelid))
